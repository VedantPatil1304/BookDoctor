...
const services = [
  {
    ...
    description: 'Consult with doctors for general or specialty care without hospital admission.',
  ...
  },
  {
    ...
    description: 'Access lab tests, imaging, and other diagnostic procedures.',
  ...
  },
  {
    ...
    description: 'Round-the-clock access to medications and safe blood services.',
    image: 'https://images.pexels.com/photos/5910953/pexels-photo-5910953.jpeg?auto=compress&cs=tinysrgb&w=600',
  },
  {
    title: 'Surgical Services',
    description: 'Comprehensive surgical procedures by expert medical professionals.',
  ...
  },
  {
    ...
    description: 'Safe delivery, prenatal and postnatal care for mothers and children.',
  ...
  },
  {
    ...
    description: '24/7 emergency support with advanced ICU and trauma facilities.',
        ...
        {services.map((service, index) => (
          ...
          >
            ...
            <div className="p-4">
              ...
              <p className="text-sm text-gray-600 mt-2 text-center">{service.description}</p>
            </div>
          </div>
        ))}
      </div>
